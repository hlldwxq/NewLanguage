...
euclid: llvmir tests/euclid.q
	./llvmir tests/euclid.q > tests/euclid.ll || echo "TODO FIXME Fix this segfault!"
	
	llvm-as-10 -disable-output tests/euclid.ll
	
	clang-10 -Wall -Wextra -g -o tests/euclidre tests/euclid.c tests/euclid.ll
	./tests/euclidre
